...
// Dashboard > Categories > Edit > [name]
Breadcrumbs::for('edit_nama_category', function (BreadcrumbTrail $trail, $category) {
    $trail->parent('edit_category', $category);
    $trail->push($category->name, route('categories.edit', ['category' => $category]));
});
